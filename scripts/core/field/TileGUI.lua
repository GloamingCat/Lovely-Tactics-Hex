...
local tileAnimID = Config.animations.tileCursorID
local tileHLAnimID = Config.animations.tileHLID
...
function TileGUI:init(tile)
  ...
  if tileHLAnimID >= 0 then
    local hlAnim = Database.animations[tileHLAnimID]
