...
-- @param x The value of the compared.
-- @param default The value returned if `x` equals to `invalid`.
-- @param[opt] invalid The value representing an invalid value.
-- @return `x` if `x` is valid, `default` otherwise.
